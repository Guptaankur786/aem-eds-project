...
## Environments
- Preview: https://main--aem-eds-project--Guptaankur786.aem.page/
- Live: https://main--aem-eds-project--Guptaankur786.aem.live/
...
1. Open the `aem-eds-project` directory in your favorite IDE and start coding :)
